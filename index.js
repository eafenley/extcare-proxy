...
app.post('/', async (req, res) => {
  ...
  console.log('=== INCOMING REQUEST FROM MOBOTIX ===');
  ...
  try {
    ...
    console.log('=== FORWARDING TO EXTENDEDCARE ===');
    console.log('Target URL:', targetUrl);
    console.log('Payload being sent:', bodyStr);
    ...
    console.log('=== RESPONSE FROM EXTENDEDCARE ===');
